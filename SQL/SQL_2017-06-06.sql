...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Jun-2017 às 20:10
...
INSERT INTO `tb_cst_csosn` (`Id`, `Codigo`, `UF`, `Aliquota`, `IdUsuarioInclusao`, `DataInclusao`, `IdUsuarioAlteracao`, `DataAlteracao`, `IdOrigem`) VALUES
(1, '000', 'SP', '18.00', 1, '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00', 1);
...
INSERT INTO `tb_produto` (`IdOrigem`, `Id`, `IdUsuarioInclusao`, `DataInclusao`, `IdUsuarioAlteracao`, `DataAlteracao`, `Codigo`, `CodigosAlternativos`, `Descricao`, `IdUnidadeApresentacao`, `IdGrupo`, `IdSubGrupo`, `IdSetor`, `IdFornecedor`, `IdTipo`, `Id_CST_CSOSN`, `Id_NCM_SH`, `IdCest`, `IdTipoPrecoApresentacao`, `Qtde_Estoque`) VALUES
