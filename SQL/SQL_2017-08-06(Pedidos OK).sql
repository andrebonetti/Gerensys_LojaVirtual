...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Ago-2017 às 04:28
...
(10, 'Vastenir Bonetti', 'vastenir@gerensys.com,br', NULL, '975356753', 'e10adc3949ba59abbe56e057f20f883e', '2017-07-19 09:37:00', '0000-00-00 00:00:00', 1);
...
(4, 10, 1, '03627-100', 'Rua André Ansaldo', 2, 'A', '2017-07-19 09:39:54', NULL, 1),
(5, 10, 0, '0047-8574', 'Rua João Fidelis', 13, 'A', '2017-07-19 09:40:17', NULL, 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_cliente_favoritos`
--

CREATE TABLE IF NOT EXISTS `tb_cliente_favoritos` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `IdCliente` bigint(20) NOT NULL,
...
--
-- Extraindo dados da tabela `tb_cliente_favoritos`
--

INSERT INTO `tb_cliente_favoritos` (`Id`, `IdCliente`, `IdProduto`, `DataInclusao`, `IdOrigem`) VALUES
(13, 6, 2, '2017-07-18 06:38:14', 1),
(14, 6, 3, '2017-07-18 06:38:17', 1),
(15, 10, 2, '2017-07-19 09:43:23', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_cliente_pedidos`
--

CREATE TABLE IF NOT EXISTS `tb_cliente_pedidos` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Numero` varchar(25) NOT NULL,
  `IdCliente` bigint(20) NOT NULL,
  `IdPedidoStatus` int(11) NOT NULL,
  `ValorTotal` decimal(7,2) NOT NULL,
  `QtdeProdutos` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `tb_cliente_pedidos`
--

INSERT INTO `tb_cliente_pedidos` (`Id`, `Numero`, `IdCliente`, `IdPedidoStatus`, `ValorTotal`, `QtdeProdutos`, `DataPedido`, `DataEntrega`) VALUES
(5, 'YTX8W6FD', 6, 1, '297.90', 2, '2017-08-03 15:49:02', NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_cliente_pedido_produtos`
--

CREATE TABLE IF NOT EXISTS `tb_cliente_pedido_produtos` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `IdPedido` bigint(20) NOT NULL,
  `IdProduto` bigint(20) NOT NULL,
  `Classificacao` decimal(2,0) DEFAULT NULL,
  `Comentario` text,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;

--
-- Extraindo dados da tabela `tb_cliente_pedido_produtos`
--

INSERT INTO `tb_cliente_pedido_produtos` (`Id`, `IdPedido`, `IdProduto`, `Classificacao`, `Comentario`) VALUES
(3, 5, 2, NULL, NULL),
(4, 5, 5, NULL, NULL);
...
INSERT INTO `tb_grupo` (`Id`, `IdSetor`, `Ordem`, `Descricao`, `IdUsuarioInclusao`, `DataInclusao`, `IdUsuarioAlteracao`, `DataAlteracao`, `IdOrigem`) VALUES
(1, 1, 2, 'Calçados', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1),
(2, 1, 1, 'Roupas', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1),
(3, 1, 3, 'Bolsas e Acessórios', 1, '2017-06-30 00:00:00', NULL, NULL, 1);
...
CREATE TABLE IF NOT EXISTS `tb_produto` (
  ...
  `PorcentagemJuros` decimal(7,2) DEFAULT NULL,
...
INSERT INTO `tb_produto_fotos` (`Id`, `IdProduto`, `Ordem`, `NomeArquivo`, `IdUsuarioInclusao`, `DataInclusao`, `IdUsuarioAlteracao`, `DataAlteracao`, `IdOrigem`) VALUES
(1, 1, 1, 'Sapatilha AZALEIA Conforto Branca_01.jpg', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1),
(2, 1, 2, 'Sapatilha AZALEIA Conforto Branca_02.jpg', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1),
(3, 2, 1, 'Camisa Polo Aramis Bordado Degrade Azul_01.jpg', 1, '2017-06-30 00:00:00', NULL, NULL, 1),
(4, 2, 2, 'Camisa Polo Aramis Bordado Degrade Azul_02.jpg', 1, '2017-06-30 00:00:00', NULL, NULL, 1),
(5, 2, 3, 'Camisa Polo Aramis Bordado Degrade Azul_03.jpg', 1, '2017-06-30 00:00:00', NULL, NULL, 1),
...
(9, 5, 2, 'Vestido manola babado bordo_02.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(10, 6, 1, 'Sapatenis Calvin Klein Estampa Cinza_01.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(11, 6, 2, 'Sapatenis Calvin Klein Estampa Cinza_02.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(12, 6, 3, 'Sapatenis Calvin Klein Estampa Cinza_03.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(13, 7, 1, 'Pantufa Tatibella Baby Coroa Rosa_01.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(14, 7, 2, 'Pantufa Tatibella Baby Coroa Rosa_01.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(15, 8, 1, 'Bolsa Shopping Ellus Tag Preta_01.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(16, 8, 2, 'Bolsa Shopping Ellus Tag Preta_02.jpg', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
...
(21, 12, 2, 'Tenis Nike Zoom Winflo 4 Azul_02.jpg', 1, '2017-07-04 00:00:00', NULL, NULL, 1),
(22, 12, 3, 'Tenis Nike Zoom Winflo 4 Azul_03.jpg', 1, '2017-07-04 00:00:00', NULL, NULL, 1);
...
(4, 1, '6000.00', 4, 1, '2017-06-30 00:00:00', NULL, NULL, 1),
...
(9, 1, '871.08', 9, 1, '2017-07-04 00:00:00', NULL, NULL, 1),
...
--
-- Estrutura da tabela `tb_r_setorxgrupoxsubgrupo`
--

CREATE TABLE IF NOT EXISTS `tb_r_setorxgrupoxsubgrupo` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `IdSetor` bigint(20) NOT NULL,
  `IdGrupo` bigint(20) NOT NULL,
  `IdSubGrupo` bigint(20) NOT NULL,
  `IdUsuarioInclusao` bigint(20) NOT NULL DEFAULT '1',
  `DataInclusao` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `IdUsuarioAlteracao` bigint(20) DEFAULT NULL,
  `DataAlteracao` datetime DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
--
-- Extraindo dados da tabela `tb_r_setorxgrupoxsubgrupo`
--

INSERT INTO `tb_r_setorxgrupoxsubgrupo` (`Id`, `IdSetor`, `IdGrupo`, `IdSubGrupo`, `IdUsuarioInclusao`, `DataInclusao`, `IdUsuarioAlteracao`, `DataAlteracao`) VALUES
(1, 1, 1, 1, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(2, 2, 1, 1, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(3, 1, 1, 2, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(4, 2, 1, 2, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(5, 1, 1, 3, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(6, 1, 1, 4, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(7, 2, 1, 4, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(8, 1, 1, 5, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(9, 2, 1, 5, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(10, 4, 1, 5, 1, '2017-07-26 21:20:28', 0, '0000-00-00 00:00:00'),
(11, 1, 2, 6, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(12, 2, 2, 6, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(13, 3, 2, 6, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(14, 4, 2, 6, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(15, 1, 2, 7, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(16, 2, 2, 7, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(17, 1, 2, 8, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(18, 2, 2, 8, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(19, 1, 2, 9, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(20, 2, 2, 9, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(21, 2, 2, 10, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(22, 3, 3, 11, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(23, 1, 2, 12, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(24, 3, 1, 13, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(25, 1, 3, 14, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(26, 3, 3, 14, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(27, 4, 3, 14, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(28, 1, 3, 15, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(29, 2, 3, 15, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(30, 4, 3, 15, 1, '2017-07-26 21:30:54', NULL, '0000-00-00 00:00:00'),
(31, 3, 2, 16, 1, '2017-07-26 21:36:36', NULL, NULL),
(32, 1, 3, 17, 1, '2017-07-26 21:36:36', NULL, NULL),
(33, 2, 3, 17, 1, '2017-07-26 21:36:36', NULL, NULL),
(34, 4, 3, 17, 1, '2017-07-26 21:36:36', NULL, NULL);
...
INSERT INTO `tb_setor` (`Id`, `Ordem`, `Descricao`, `IdUsuarioInclusao`, `DataInclusao`, `IdUsuarioAlteracao`, `DataAlteracao`, `IdOrigem`) VALUES
(1, 2, 'Feminino', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1),
(2, 1, 'Masculino', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1),
(3, 3, 'Infantil', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1),
(4, 4, 'Esporte', 1, '2017-06-30 00:00:00', 0, '0000-00-00 00:00:00', 1);
...
--
-- Estrutura da tabela `tb_sys_cliente_pedido_status`
--

CREATE TABLE IF NOT EXISTS `tb_sys_cliente_pedido_status` (
...
--
-- Extraindo dados da tabela `tb_sys_cliente_pedido_status`
--

INSERT INTO `tb_sys_cliente_pedido_status` (`Id`, `Descricao`) VALUES
