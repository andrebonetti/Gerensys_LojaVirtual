...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Jun-2017 às 15:14
...
--
-- Estrutura da tabela `tb_cst-csosn_log`
--

CREATE TABLE IF NOT EXISTS `tb_cst-csosn_log` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Codigo` varchar(3) NOT NULL,
  `UF` varchar(2) NOT NULL,
  `Aliquota` decimal(7,2) NOT NULL,
...
--
-- Estrutura da tabela `tb_fotos-produtos_log`
--
...
--
-- Estrutura da tabela `tb_ncm-sh_log`
--
...
--
-- Estrutura da tabela `tb_produtos_log`
--
