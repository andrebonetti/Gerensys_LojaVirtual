...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Jul-2017 às 06:09
...
INSERT INTO `tb_marca` (`Id`, `Descricao`, `IdUsuarioInclusao`, `DataInclusao`, `IdUsuarioAlteracao`, `DataAlteracao`, `IdOrigem`) VALUES
...
(9, 'Manola', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(10, 'Calvin Klein', 1, '2017-07-03 00:00:00', NULL, NULL, 1),
(11, 'Tatibella Baby', 1, '2017-07-03 00:00:00', NULL, NULL, 1);
...
CREATE TABLE IF NOT EXISTS `tb_produto` (
  ...
  `MediaClassificacao` decimal(2,2) NOT NULL,
  `EstoqueTotal` int(11) NOT NULL,
...
(8, 'EL648ACF68LBJ', 'Bolsa Shopping Ellus Tag Preta', 1, 3, NULL, NULL, 5, 0, NULL, '0.00', 0, 0, 0, NULL, 1, 'Bolsa Shopping Ellus Tag Preta, com acabamento texturizado, tag da marca e fecho por botão magnético. Possui alças de ombro de 52cm. Medidas: 30x35x12cm. (LxAxP)', 'SKU	EL648ACF68LBJ\r\nModelo	Ellus 46ZW009\r\nMaterial Externo	Sintético\r\nMaterial Interno	Têxtil\r\nCor	Preto\r\nAltura	35\r\nLargura	30\r\nProfundidade	12\r\nTipo de frete:	Leve', '0.000', '0.000', 1, 1, '2017-07-03 00:00:00', NULL, NULL);
